...
class Application
{
    ...
    Application()
    {
        ...
        glade=Gtk::Builder::create_from_resource("/lliurex/mrpdi/interface.ui");
        ...
        pix_tablet = Gdk::Pixbuf::create_from_resource("/lliurex/mrpdi/tablet.svg");
        pix_whiteboard = Gdk::Pixbuf::create_from_resource("/lliurex/mrpdi/whiteboard.svg");
